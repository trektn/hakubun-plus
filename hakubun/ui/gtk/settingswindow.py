...
class SettingsWindow(Gtk.Window):
    ...
    def __init__(self, engine, config, configfile, transient_for=None):
        ...
        self.combo_mpris_update_mode.connect(
            "changed", self._on_mpris_update_mode_changed)
    ...
    def _load_config(self):
        ...
        mpris_obey_wait = self.engine.get_config('mpris_obey_update_wait_s')
        self.combo_mpris_update_mode.set_active_id(
            'fixed' if mpris_obey_wait else 'percentage')
        self.spin_tracker_update_percentage.set_value(
            self.engine.get_config('tracker_update_percentage'))
        self.spin_tracker_update_percentage.set_sensitive(not mpris_obey_wait)
    ...
    def _on_mpris_update_mode_changed(self, combo):
        self.spin_tracker_update_percentage.set_sensitive(
            combo.get_active_id() == 'percentage')
    ...
    def save_config(self):
        ...
        self.engine.set_config(
            'mpris_obey_update_wait_s',
            self.combo_mpris_update_mode.get_active_id() == 'fixed')
        self.engine.set_config(
            'tracker_update_percentage',
