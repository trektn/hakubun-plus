...
class TrackerBase(object):
    ...
    def __init__(self, messenger, tracker_list, config, watch_dirs, redirections=None):
        ...
        # Episode duration in milliseconds, when the tracker backend can
        # report one (currently MPRIS only) -- lets the UI show watch
        # percentage instead of just elapsed time.
        self.length = None
